...
bool GameApp::InitResource()
{
    ...
    Transform& houseTransform1 = m_House1.GetTransform();
    houseTransform1.SetScale(0.015f, 0.015f, 0.015f);
    houseTransform1.SetPosition(0.0f, -(houseBox.Center.y - houseBox.Extents.y - 5.0f), 0.0f);
