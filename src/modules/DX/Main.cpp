...
LPCWSTR g_szAppName = L"TeamProject";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"TeamProjectWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"TeamProjectWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
